        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:#132639">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="masakan" class="nav-link active">
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="{{route('simpanmasakan')}}">
                                    @csrf
                                    <div class="card-body">

                                        <div class="form-group">
                                            <label for="Inputnamamasakan">Nama</label>
                                            <input name="namamasakan" type="text" class="form-control" id="Input_nama_masakan" placeholder="Masukan Nama Masakan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="Inputgambar">Gambar</label>
                                            <input name="namagambar" type="text" class="form-control" id="Input_gambar" placeholder="Masukan Gambar" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="Inputhargamasakan">Harga</label>
                                            <input name="hargamasakan" type="number" class="form-control" id="Input_harga_masakan" placeholder="Masukan Harga Masakan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="Inputstatusmasakan">Status</label>
                                            <input name="statusmasakan" type="text" class="form-control" id="Input_status_masakan" placeholder="Masukan Status Masakan" required>
                                        </div>
