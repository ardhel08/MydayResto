                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <a href="{{url('/tambahmasakan')}}">
                                    <button type="button" class="btn btn-success"><i class="nav-icon fas fa-plus"></i></button>
                                </a>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="editmasakan/{{$masakans->id_masakan}}"><button type="button" class="btn btn-warning btn-sm"><i class="nav-icon far fa-edit"></i></button></a>
                                                        <a href="hapusmasakan/{{$masakans->id_masakan}}" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><button type="button" class="btn btn-danger btn-sm"><i class="nav-icon far fa-trash-alt"></i></button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
